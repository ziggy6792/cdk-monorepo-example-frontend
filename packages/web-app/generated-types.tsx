...
export const GetCompetitionDocument = gql`
  ...
  getCompetition(id: $competitionId) {
    ...
    `;
export type GetCompetitionComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<GetCompetitionQuery, GetCompetitionQueryVariables>, 'query'> & ({ variables: GetCompetitionQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const GetCompetitionComponent = (props: GetCompetitionComponentProps) => (
      <ApolloReactComponents.Query<GetCompetitionQuery, GetCompetitionQueryVariables> query={GetCompetitionDocument} {...props} />
    );
    
export type GetCompetitionProps<TChildProps = {}> = ApolloReactHoc.DataProps<GetCompetitionQuery, GetCompetitionQueryVariables> | TChildProps;
export function withGetCompetition<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetCompetitionQuery,
  GetCompetitionQueryVariables,
  GetCompetitionProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, GetCompetitionQuery, GetCompetitionQueryVariables, GetCompetitionProps<TChildProps>>(GetCompetitionDocument, {
      alias: 'getCompetition',
      ...operationOptions
    });
};
...
export const ListEventsDocument = gql`
  ...
  listEvents {
    ...
    `;
export type ListEventsComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<ListEventsQuery, ListEventsQueryVariables>, 'query'>;

    export const ListEventsComponent = (props: ListEventsComponentProps) => (
      <ApolloReactComponents.Query<ListEventsQuery, ListEventsQueryVariables> query={ListEventsDocument} {...props} />
    );
    
export type ListEventsProps<TChildProps = {}> = ApolloReactHoc.DataProps<ListEventsQuery, ListEventsQueryVariables> | TChildProps;
export function withListEvents<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  ListEventsQuery,
  ListEventsQueryVariables,
  ListEventsProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, ListEventsQuery, ListEventsQueryVariables, ListEventsProps<TChildProps>>(ListEventsDocument, {
      alias: 'listEvents',
      ...operationOptions
    });
};
...
export const GetDataEntityDocument = gql`
  ...
  getDataEntity(id: $id) {
    ...
    `;
export type GetDataEntityComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<GetDataEntityQuery, GetDataEntityQueryVariables>, 'query'> & ({ variables: GetDataEntityQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const GetDataEntityComponent = (props: GetDataEntityComponentProps) => (
      <ApolloReactComponents.Query<GetDataEntityQuery, GetDataEntityQueryVariables> query={GetDataEntityDocument} {...props} />
    );
    
export type GetDataEntityProps<TChildProps = {}> = ApolloReactHoc.DataProps<GetDataEntityQuery, GetDataEntityQueryVariables> | TChildProps;
export function withGetDataEntity<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetDataEntityQuery,
  GetDataEntityQueryVariables,
  GetDataEntityProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, GetDataEntityQuery, GetDataEntityQueryVariables, GetDataEntityProps<TChildProps>>(GetDataEntityDocument, {
      alias: 'getDataEntity',
      ...operationOptions
    });
};
