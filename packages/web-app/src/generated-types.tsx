...
export type Event = DataEntity & Identifiable & Creatable & Schedulable & {
   __typename?: 'Event',
  createdAt: Scalars['DateTime'],
  modifiedAt: Scalars['DateTime'],
  id: Scalars['ID'],
...
export type Heat = DataEntity & Identifiable & Creatable & Schedulable & {
   __typename?: 'Heat',
  createdAt: Scalars['DateTime'],
  modifiedAt: Scalars['DateTime'],
  id: Scalars['ID'],
...
export type Round = Identifiable & Creatable & Schedulable & {
   __typename?: 'Round',
  createdAt: Scalars['DateTime'],
  modifiedAt: Scalars['DateTime'],
  id: Scalars['ID'],
...
export type GetEventQuery = (
  ...
  & { getEvent: (
    { __typename?: 'Event' }
    & Pick<Event, 'name' | 'startTime' | 'description'>
    & { adminUser: (
      { __typename?: 'User' }
      & Pick<User, 'fullName'>
    ), competitions: (
