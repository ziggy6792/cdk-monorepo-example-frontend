...
export type RankedRidersFieldsFragment = (
  { __typename?: 'Competition' }
  & { rankedRiders: (
    { __typename?: 'RiderRankList' }
    & { items: Array<(
      { __typename?: 'RiderRank' }
      & Pick<RiderRank, 'userId' | 'rank'>
      & { user: Maybe<(
        { __typename?: 'User' }
...
export type CoreCompetitionFieldsFragment = (
  ...
  & { event: (
    ...
    & { items: Array<(
      { __typename?: 'RiderAllocation' }
      & Pick<RiderAllocation, 'userId' | 'allocatableId' | 'startSeed'>
      & { user: Maybe<(
        { __typename?: 'User' }
        & Pick<User, 'id' | 'fullName'>
      )> }
      ...
      & { heats: (
        ...
        & { items: Array<(
          ...
          & { round: (
            ...
            & { items: Array<(
              { __typename?: 'RiderAllocation' }
              & Pick<RiderAllocation, 'userId' | 'allocatableId'>
              & { user: Maybe<(
                { __typename?: 'User' }
                & Pick<User, 'id' | 'fullName'>
              )> }
...
export type GetEventQuery = (
  ...
  & { getEvent: (
    ...
    & { adminUser: (
      ...
      & { items: Array<(
        { __typename?: 'Competition' }
        & Pick<Competition, 'id' | 'status' | 'name' | 'startTime'>
        & { judgeUser: Maybe<(
          { __typename?: 'User' }
          & Pick<User, 'id' | 'fullName'>
        )> }
...
export type CoreHeatFieldsFragment = (
  ...
  & { round: (
    ...
    & { items: Array<(
      { __typename?: 'RiderAllocation' }
      & Pick<RiderAllocation, 'userId' | 'allocatableId' | 'startSeed' | 'startOrder' | 'rankOrder' | 'position'>
      & { user: Maybe<(
        { __typename?: 'User' }
        & Pick<User, 'id' | 'fullName'>
      )>, runs: Maybe<Array<(
