...
export type RiderRank = {
  __typename?: 'RiderRank';
  userId: Scalars['String'];
  rank: Scalars['Int'];
  user?: Maybe<User>;
};

export type RiderRankList = {
  __typename?: 'RiderRankList';
...
export type RankedRidersFieldsFragment = { __typename?: 'Competition' } & {
  rankedRiders: { __typename?: 'RiderRankList' } & {
    items: Array<{ __typename?: 'RiderRank' } & Pick<RiderRank, 'userId' | 'rank'> & { user: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'fullName'>> }>;
  };
};

export type CoreCompetitionFieldsFragment = { __typename?: 'Competition' } & Pick<
  Competition,
  'id' | 'status' | 'isAdmin' | 'isJudge' | 'hasDemoRiders' | 'name' | 'description' | 'level' | 'gender' | 'sport' | 'maxRiders' | 'judgeUserId'
> & {
    ...
    riderAllocations: { __typename?: 'RiderAllocationList' } & {
      items: Array<
        { __typename?: 'RiderAllocation' } & Pick<RiderAllocation, 'userId' | 'allocatableId' | 'startSeed'> & {
            ...
            heats: { __typename?: 'HeatList' } & {
              items: Array<
                { __typename?: 'Heat' } & Pick<Heat, 'id' | 'isFinal' | 'name' | 'size' | 'noAllocated' | 'createdAt' | 'status'> & {
                    round: { __typename?: 'Round' } & Pick<Round, 'id' | 'roundNo'>;
                    riderAllocations: { __typename?: 'RiderAllocationList' } & {
                      items: Array<
                        { __typename?: 'RiderAllocation' } & Pick<RiderAllocation, 'userId' | 'allocatableId'> & {
                            user: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'fullName'>>;
                          }
                      >;
                    };
        ...
        rounds: { __typename?: 'RoundList' } & {
          items: Array<
            { __typename?: 'Round' } & Pick<Round, 'id'> & {
                heats: { __typename?: 'HeatList' } & {
                  items: Array<
                    { __typename?: 'Heat' } & Pick<Heat, 'id' | 'name'> & {
                        riderAllocations: { __typename?: 'RiderAllocationList' } & {
                          items: Array<{ __typename?: 'RiderAllocation' } & Pick<RiderAllocation, 'userId' | 'allocatableId' | 'startSeed'>>;
                        };
                      }
                  >;
                };
...
export type GetEventQuery = { __typename?: 'Query' } & {
  getEvent: { __typename?: 'Event' } & Pick<Event, 'isAdmin' | 'id' | 'name' | 'startTime' | 'description'> & {
      adminUser: { __typename?: 'User' } & Pick<User, 'id' | 'fullName'>;
      competitions: { __typename?: 'CompetitionList' } & {
        items: Array<
          { __typename?: 'Competition' } & Pick<Competition, 'id' | 'status' | 'name' | 'startTime'> & {
              judgeUser: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'fullName'>>;
            } & RankedRidersFieldsFragment
        >;
      };
...
export type GetSelectedHeatQuery = { __typename?: 'Query' } & {
  getEvent: { __typename?: 'Event' } & Pick<Event, 'id' | 'name'> & {
      selectedHeat: Maybe<{ __typename?: 'Heat' } & BreadcrumbFields_Heat_Fragment & CoreHeatFieldsFragment>;
    };
};
...
> & {
    round: { __typename?: 'Round' } & Pick<Round, 'id' | 'roundNo' | 'longName'>;
    riderAllocations: { __typename?: 'RiderAllocationList' } & {
      items: Array<
        { __typename?: 'RiderAllocation' } & Pick<RiderAllocation, 'userId' | 'allocatableId' | 'startSeed' | 'startOrder' | 'rankOrder' | 'position'> & {
            user: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'fullName'>>;
...
export type UpdateRiderAllocationsMutation = { __typename?: 'Mutation' } & {
  updateRiderAllocations: Array<{ __typename?: 'RiderAllocation' } & Pick<RiderAllocation, 'userId' | 'allocatableId'>>;
};
...
`;
export const RankedRidersFieldsFragmentDoc = gql`
