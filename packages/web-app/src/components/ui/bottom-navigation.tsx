...
import { createStyles, makeStyles, Theme, Card, BottomNavigation as MuiBottomNavigation, BottomNavigationAction } from '@material-ui/core';
...
const BottomNavigation: React.FC<BottomNavProps> = ({ eventId, currentPath }) => {
  ...
  return (
    <Card className={classes.root}>
      <MuiBottomNavigation value={currentPath} showLabels onChange={handleChange}>
